...
def get_private_users_client(user: AuthenticationUsersSchema) -> PrivateUsersClient:
    """
    Функция создает экземпляр UsersClient с уже настроенным http клиентом и авторизацией
    :return: Готовый к работе экземпляр UsersClient
    """
