...
from tools.assertions.courses import assert_updated_courses_response, assert_get_courses_response, assert_course, \
    assert_created_course_response
...
class TestCourses:
    ...
    def test_create_course(self,
        ...
        assert_status_code(response.status_code, HTTPStatus.OK)
        assert_created_course_response(response=response_data, request=request)
