...
- Allure Reporting for comprehensive and visually appealing test execution reports with detailed insights
- CI/CD Pipeline to automated test runs triggered by GitHub Actions (push and pull request)
- Advanced techniques to improve test efficiency and reliability
...
```bash
git clone https://github.com/kotov-e/autotests-api.git
cd your-repo-name
```
